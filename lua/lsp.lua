...
vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(args)
        ...
        -- grx     | run codelens
        -- gO      | document symbols
        -- gx      | document link öffnen
        -- C-s     | signature help in  Insert mode
        -- an/in   | selection ranges
...
local servers_by_ft = {
    ...
    htmldjango = { 'emmet_ls' },
    javascript = { 'tsc', 'tailwindcss' },
    ['javascript.jsx'] = { 'tsc', 'tailwindcss' },
    javascriptreact = { 'tsc', 'emmet_ls', 'tailwindcss' },
    json = { 'jsonls' },
    jsonc = { 'jsonls' },
    ...
    ['typescript.tsx'] = { 'tsc', 'tailwindcss' },
